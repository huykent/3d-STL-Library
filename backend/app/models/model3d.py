...
class Model3D(Base):
    ...
    is_presupported: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, index=True)
    studio_name: Mapped[Optional[str]] = mapped_column(String(100), nullable=True, index=True)
    ...
    telegram_target_message_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
